...
public class JoinUsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_join=view.findViewById(R.id.btn_joinus);
        btn_join.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Intent intent = new Intent(getContext(), JoinUs.class);
//                startActivity(intent);
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.cloudcounselage.com/iac/?utm_source=TeamEntity&utm_medium=hackathon_2022&utm_campaign=CloudCounselage"));
